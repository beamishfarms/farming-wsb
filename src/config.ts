...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    deployments: require('./wsb/deployments/deployments.rinkeby.json'),
    externalTokens: {
      'ETH_PROPHET-UNI-LPv2': ['0x22aDE3578c58BC4e932fc23fa7AebCf9406DBEac', 18],
      'WSB_ETH-UNI-LPv2': ['0x22c61E482d67E2C4676892B974f5628dF4e12FA8', 18],
...
export const farmDefinitions: { [contractName: string]: FarmInfo } = {
  WSBETHPool: {
    name: 'Earn WSB by WSB-ETH LP',
    contract: 'WSBETHPool',
    depositTokenName: 'WSB_ETH-UNI-LPv2',
    earnTokenName: 'WSB',
    finished: false,
    sort: 1,
  },
